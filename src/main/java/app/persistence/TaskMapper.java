...
public class TaskMapper
{
    ...
    public static List<Task> getAllTasksPerUser(int userId, app.persistence.ConnectionPool connectionPool) throws DatabaseException
    {
    ...
    public static Task addTask(User user, String taskName, app.persistence.ConnectionPool connectionPool) throws DatabaseException
    {
        Task newTask = null;
    ...
    public static void setDoneTo(boolean done, int taskId, app.persistence.ConnectionPool connectionPool) throws DatabaseException
    {
    ...
    public static void delete(int taskId, app.persistence.ConnectionPool connectionPool) throws DatabaseException
    {
    ...
    public static Task getTaskById(int taskId, app.persistence.ConnectionPool connectionPool) throws DatabaseException
    {
        Task task = null;
